...
void CharacterDatabaseConnection::DoPrepareStatements()
{
	...
	PrepareStatement(CHAR_SEL_ACCOUNT_DMLEVEL, "SELECT dmlevel FROM account_dm_levels WHERE accountId = ?", CONNECTION_SYNCH);
	...
	PrepareStatement(CHAR_SEL_CHARACTER_ROLE_STATS, "SELECT STR, AGI, INTEL, VIT, DEX, WILL, SPI FROM character_role_stats WHERE guid = ?", CONNECTION_ASYNC); // ROLE STAT SYSTEM
