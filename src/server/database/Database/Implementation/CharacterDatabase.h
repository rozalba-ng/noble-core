...
enum CharacterDatabaseStatements
{
    ...
    */
	...
	CHAR_SEL_ACCOUNT_DMLEVEL,
	CHAR_DEL_NONEXISTENT_CONTAINER_ITEM,
	CHAR_DEL_CONTAINER_ITEMS,
	CHAR_INS_CONTAINER_ITEM,
	CHAR_SEL_CHARACTER_ROLE_STATS, // ROLE STAT SYSTEM
    CHAR_INS_CHARACTER_CHAT_LOG, // ROLE STAT SYSTEM
    CHAR_SEL_CHARACTER_LEVEL_SYSTEM, //LEVEL SYSTEM
