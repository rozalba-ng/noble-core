...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_IGNORE_PATHFINDING | CREATURE_FLAG_EXTRA_NO_PLAYER_DAMAGE_REQ | CREATURE_FLAG_EXTRA_IMMUNITY_KNOCKBACK | CREATURE_FLAG_EXTRA_WATERWALKING)
...
struct CreatureData
{
    CreatureData() : id(0), mapid(0), phaseMask(0), displayid(0), equipmentId(0),
                     ...
                     spawnMask(0), npcflag(0), unit_flags(0), dynamicflags(0), owner_id(0), dbData(true) { }
...
class TC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool Create(ObjectGuid::LowType guidlow, Map* map, uint32 phaseMask, uint32 entry, float x, float y, float z, float ang, CreatureData const* data = nullptr, uint32 vehId = 0, uint32 owner_id = 0);
