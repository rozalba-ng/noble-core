...
enum RBACPermissions
{
	...
	RBAC_PERM_COMMAND_RELOAD_ALL_CREATURE_TEMPLATE			 = 850,
	RBAC_PERM_COMMAND_RELOAD_ALL_GAMEOBJECT_TEMPLATE		 = 851,
	RBAC_PERM_COMMAND_RELOAD_ALL_ITEM_TEMPLATE				 = 852,
	RBAC_PERM_COMMAND_RELOAD_NPC_TEXT						 = 853,
	RBAC_PERM_COMMAND_RELOAD_CREATURE_EQUIPMENT_TEMPLATE	 = 854,
	RBAC_PERM_COMMAND_RELOAD_CREATURE_TEMPLATE_ADDON         = 855,
